...
namespace Demo.Tests
{
    public class AssertingRangesTests
    {
        //Teste Teorico
        [Theory]
        [InlineData(700)] // no "InlineData" é necessário passar os mesmo parametros do método e serão incluídos valor no parametro p/ testar o método
        [InlineData(1500)]
        [InlineData(2000)]
        [InlineData(7500)]
        [InlineData(8000)]
        ...
        {
            // Arrange & Act
            var funcionario = new Funcionario("Wagner", salario);
