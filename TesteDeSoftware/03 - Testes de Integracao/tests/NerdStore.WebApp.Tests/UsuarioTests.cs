...
namespace NerdStore.WebApp.Tests
{
    ...
    public class UsuarioTests
    {
        ...
        public async Task Usuario_RealizarCadastro_DeveExecutarComSucesso()
        {
            ...
            initialResponse.EnsureSuccessStatusCode(); // verifica se o status code é 200
            ...
            //Criando um postRequest da pagina "/Identity/Account/Register" e criando o conteudo "Content" para fazer o Post no método "SendAsync"
            ...
            // Assert
            var responseString = await postResponse.Content.ReadAsStringAsync(); //transforma o conteudo "Content" HTML em string para fazer validaçoes
            postResponse.EnsureSuccessStatusCode(); // verifica se o status code é 200
